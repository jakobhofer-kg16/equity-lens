          ...
          <div className="flex items-start gap-3">
            {profile.logoUrl ? (
              <img
                ...
                // A broken logo URL should leave the initials badge, not a gap.
                onError={(e) => {
            ...
            <span
              className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-sm font-bold text-slate-700 ${profile.logoUrl ? 'hidden' : ''}`}
            >
